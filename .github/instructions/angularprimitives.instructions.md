...
Generated on: 2026-04-09T20:09:09.920Z
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpAccordionType` | `'single' | 'multiple'` | `-` | The type of the accordion. |
...
| `ngpAccordionOrientation` | `'horizontal' | 'vertical'` | `-` | The accordion orientation. |
...
| `ngpComboboxDropdownPlacement` | `'top' | 'right' | 'bottom' | 'left' | 'top-start' | 'top-end' | 'right-start' | 'right-end' | 'bottom-start' | 'bottom-end' | 'left-start' | 'left-end'` | `-` | The position of the dropdown. |
| `ngpComboboxDropdownContainer` | `string | HTMLElement | null` | `-` | The container for the dropdown. |
| `ngpComboboxDropdownFlip` | `NgpFlip` | `-` | Whether the dropdown should flip when there is not enough space. Can be a boolean to enable/disable, or an object with padding and fallbackPlacements options. |
...
| `ngpDatePickerFirstDayOfWeek` | `1 | 2 | 3 | 4 | 5 | 6 | 7` | `7 (Sunday)` | Sets which day starts the week in the calendar.
...
| `ngpDateRangePickerFirstDayOfWeek` | `1 | 2 | 3 | 4 | 5 | 6 | 7` | `7 (Sunday)` | Sets which day starts the week in the calendar.
Accepts 0-7 where 1=Monday, 2=Tuesday, 3=Wednesday, 4=Thursday, 5=Friday, 6=Saturday, 7=Sunday.
Defaults to NgpDatePickerConfig.firstDayOfWeek (default 7 if not overridden).
Note: Update calendar header column order when changing from Sunday start. |
...
| `ngpInputOtpInputMode` | `'numeric' | 'text' | 'decimal' | 'tel' | 'search' | 'email' | 'url'` | `-` | The input mode for the hidden input. |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpListboxMode` | `'single' | 'multiple'` | `-` | The listbox selection mode. |
...
| `ngpMenuTriggerPlacement` | `'top' | 'right' | 'bottom' | 'left' | 'top-start' | 'top-end' | 'right-start' | 'right-end' | 'bottom-start' | 'bottom-end' | 'left-start' | 'left-end'` | `'bottom-start'` | Define the placement of the menu relative to the trigger. |
| `ngpMenuTriggerOffset` | `NgpOffset` | `4` | Define the offset of the menu relative to the trigger.
Can be a number (applies to mainAxis) or an object with mainAxis, crossAxis, and alignmentAxis. |
| `ngpMenuTriggerFlip` | `NgpFlip` | `true` | Define whether the menu should flip when there is not enough space for the menu.
...
| `ngpMenuTriggerScrollBehavior` | `"close" | "reposition" | "block"` | `'block'` | Defines how the menu behaves when the window is scrolled. |
| `ngpMenuTriggerCooldown` | `number` | `0` | Define the cooldown duration in milliseconds.
...
| `ngpMenuTriggerOpenTriggers` | `('click' | 'hover' | 'focus' | 'enter' | 'arrowkey')[]` | `['click']` | Define which trigger types are enabled for the menu. |
| `ngpMenuTriggerShowDelay` | `number` | `0` | Define the delay before the menu is displayed (hover/focus triggers). |
| `ngpMenuTriggerHideDelay` | `number` | `0` | Define the delay before the menu is hidden (hover/focus triggers). |
...
| `ngpMenuItemCloseOnSelect` | `boolean` | `-` | Whether the menu should close when this item is selected |
...
| `ngpSubmenuTriggerPlacement` | `'top' | 'right' | 'bottom' | 'left' | 'top-start' | 'top-end' | 'right-start' | 'right-end' | 'bottom-start' | 'bottom-end' | 'left-start' | 'left-end'` | `'right-start'` | Define the placement of the menu relative to the trigger. |
| `ngpSubmenuTriggerOffset` | `NgpOffset` | `0` | Define the offset of the menu relative to the trigger.
Can be a number (applies to mainAxis) or an object with mainAxis, crossAxis, and alignmentAxis. |
| `ngpSubmenuTriggerFlip` | `NgpFlip` | `true` | Define whether the menu should flip when there is not enough space for the menu.
Can be a boolean to enable/disable, or an object with padding and fallbackPlacements options. |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpMenuItemCheckboxChecked` | `boolean` | `-` | Whether the checkbox is checked |
| `ngpMenuItemCheckboxDisabled` | `boolean` | `-` | Whether the menu item checkbox is disabled |

#### Outputs

| Event | Type | Description |
|-------|------|-------------|
| `ngpMenuItemCheckboxCheckedChange` | `boolean` | Event emitted when the checked state changes |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpMenuItemRadioGroupValue` | `string | null` | `-` | The current value of the radio group |

#### Outputs

| Event | Type | Description |
|-------|------|-------------|
| `ngpMenuItemRadioGroupValueChange` | `string` | Event emitted when the value changes |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpMenuItemRadioValue` | `string` | `-` | The value this radio item represents |
| `ngpMenuItemRadioDisabled` | `boolean` | `-` | Whether the radio item is disabled |
...
File: primitives/navigation-menu.md
URL: https://angularprimitives.com/primitives/navigation-menu
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpNavigationMenuOrientation` | `'horizontal' | 'vertical'` | `'horizontal'` | The orientation of the navigation menu. |
| `ngpNavigationMenuShowDelay` | `number` | `200` | The delay in milliseconds before showing content on hover. |
| `ngpNavigationMenuHideDelay` | `number` | `150` | The delay in milliseconds before hiding content. |
| `ngpNavigationMenuValue` | `string | null` | `-` | The currently active (open) item value. |

#### Outputs

| Event | Type | Description |
|-------|------|-------------|
| `ngpNavigationMenuValueChange` | `string | null` | Emits when the active item changes. |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpNavigationMenuListWrap` | `boolean` | `true` | Whether focus should wrap around when reaching the end of the list. |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpNavigationMenuItemValue` | `string` | `-` | A unique value identifying this menu item.
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpNavigationMenuTrigger` | `NgpOverlayContent<unknown> | undefined` | `-` | The content template or component to display. |
| `ngpNavigationMenuTriggerDisabled` | `boolean` | `false` | Whether the trigger is disabled. |
| `ngpNavigationMenuTriggerPlacement` | `Placement` | `'bottom-start'` | The placement of the content relative to the trigger. |
| `ngpNavigationMenuTriggerOffset` | `NgpOffset` | `4` | The offset of the content relative to the trigger. |
| `ngpNavigationMenuTriggerFlip` | `NgpFlip` | `true` | Whether the content should flip when there is not enough space.
Can be a boolean to enable/disable, or an object with padding and fallbackPlacements options. |
| `ngpNavigationMenuTriggerShift` | `NgpShift` | `undefined` | Configure shift behavior to keep the content in view. |
| `ngpNavigationMenuTriggerContainer` | `string | HTMLElement | null` | `'body'` | The container for the content. |
| `ngpNavigationMenuTriggerCooldown` | `number` | `300` | The cooldown duration in milliseconds.
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpNavigationMenuContentOrientation` | `'horizontal' | 'vertical'` | `'vertical'` | The orientation for keyboard navigation within the content.
Use 'vertical' for list layouts (default), 'horizontal' for grid layouts. |
| `ngpNavigationMenuContentWrap` | `boolean` | `true` | Whether focus should wrap around when reaching the end of the content. |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpNavigationMenuLinkDisabled` | `boolean` | `false` | Whether the link is disabled. |
| `ngpNavigationMenuLinkActive` | `boolean` | `false` | Whether the link is active (represents the current page). |
...
File: primitives/number-field.md
URL: https://angularprimitives.com/primitives/number-field
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpNumberFieldValue` | `number | null` | `-` | The value of the number field. |
| `ngpNumberFieldMin` | `number` | `-` | The minimum value. |
| `ngpNumberFieldMax` | `number` | `-` | The maximum value. |
| `ngpNumberFieldStep` | `number` | `-` | The step value. |
| `ngpNumberFieldLargeStep` | `number` | `-` | The large step value (used with Shift key). |
| `ngpNumberFieldDisabled` | `boolean` | `-` | The disabled state of the number field. |
| `ngpNumberFieldReadonly` | `boolean` | `-` | The readonly state of the number field. |

#### Outputs

| Event | Type | Description |
|-------|------|-------------|
| `ngpNumberFieldValueChange` | `number | null` | Emits when the value changes. |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpNumberFieldInputAllowWheelScrub` | `boolean` | `-` | Whether mouse wheel changes the value when the input is focused. |
...
| `ngpPopoverTriggerPlacement` | `'top' | 'right' | 'bottom' | 'left' | 'top-start' | 'top-end' | 'right-start' | 'right-end' | 'bottom-start' | 'bottom-end' | 'left-start' | 'left-end'` | `'top'` | Define the placement of the popover relative to the trigger. |
...
| `ngpPopoverTriggerFlip` | `NgpFlip` | `true` | Define whether the popover should flip when there is not enough space for the popover.
Can be a boolean to enable/disable, or an object with padding and fallbackPlacements options. |
...
| `ngpPopoverTriggerScrollBehavior` | `"close" | "reposition" | "block"` | `'reposition'` | Defines how the popover behaves when the window is scrolled. |
...
| `ngpPopoverTriggerCooldown` | `number` | `0` | Define the cooldown duration in milliseconds.
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpPopoverArrowPadding` | `number | undefined` | `-` | Padding between the arrow and the edges of the popover.
...
| `ngpRadioGroupOrientation` | `'horizontal' | 'vertical'` | `'horizontal'` | The orientation of the radio group. |
...
| `ngpRangeSliderOrientation` | `'horizontal' | 'vertical'` | `-` | The orientation of the range slider. |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpRovingFocusGroupOrientation` | `'horizontal' | 'vertical'` | `'vertical'` | Determine the orientation of the roving focus group. |
...
| `ngpSelectDropdownFlip` | `NgpFlip` | `-` | Whether the dropdown should flip when there is not enough space. Can be a boolean to enable/disable, or an object with padding and fallbackPlacements options. |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpSeparatorOrientation` | `'horizontal' | 'vertical'` | `-` | The orientation of the separator. |
...
| `ngpSliderOrientation` | `'horizontal' | 'vertical'` | `-` | The orientation of the slider. |
...
| `ngpTabsetOrientation` | `'horizontal' | 'vertical'` | `'horizontal'` | The orientation of the tabset |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpToggleGroupOrientation` | `'horizontal' | 'vertical'` | `-` | The orientation of the toggle group. |
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpToolbarOrientation` | `'horizontal' | 'vertical'` | `-` | The orientation of the toolbar. |
...
| `ngpTooltipTriggerPlacement` | `'top' | 'right' | 'bottom' | 'left' | 'top-start' | 'top-end' | 'right-start' | 'right-end' | 'bottom-start' | 'bottom-end' | 'left-start' | 'left-end'` | `'top'` | Define the placement of the tooltip relative to the trigger. |
...
| `ngpTooltipTriggerFlip` | `NgpFlip` | `true` | Define whether the tooltip should flip when there is not enough space for the tooltip.
Can be a boolean to enable/disable, or an object with padding and fallbackPlacements options. |
...
| `ngpTooltipTriggerScrollBehavior` | `"close" | "reposition"` | `'reposition'` | Defines how the tooltip behaves when the window is scrolled. |
| `ngpTooltipTriggerCooldown` | `number` | `300` | Define the cooldown duration in milliseconds.
...
| Property | Type | Default | Description |
|----------|------|---------|-------------|
| `ngpTooltipArrowPadding` | `number | undefined` | `-` | Padding between the arrow and the edges of the tooltip.
This prevents the arrow from overflowing the rounded corners. |
